...
REMOTE_USERNAME='Proprietario'
REMOTE_HOST='ufficio'
TOBACKUP='/cygdrive/c/Programmi/TLQ'
REMOTE_BACKUP_DEST='/cygdrive/c/backup_tlq'
BACKUP_SLAVE='/home/Proprietario/backup_slave'

LOCAL_BACKUP_DEST='/home/venator/backup_tlq'
...
[ ${backup_result} -eq 0 -a ${transfer_result} -eq 0 ] && overall_result="OK"
[ ${backup_result} -eq 255 -o ${transfer_result} -eq 255 ] && overall_result="SSH key auth failed"
[ ${backup_result} -ne 0 -o ${transfer_result} -ne 0 ] && overall_result="Errori"
